...
const PROFILE_PICTURE_URI = 'https://pbs.twimg.com/profile_images/975388677642715136/7Hw2MgQ2_400x400.jpg'

const PROFILE_BANNER_URI =
  'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/love-death-robots-animated-netflix-series-1551094395.jpg?crop=1xw:1xh;center,top&resize=980:*'

const AnimatedImageBackground = Animated.createAnimatedComponent(ImageBackground)

export function FancyStickyHeader() {
      ...
      >
        <View style={[styles.container, { backgroundColor: 'black' }]}>
          ...
          >
            ...
            <Text style={[styles.text, { marginBottom: 15, fontSize: 15 }]}>Same @ on every social media</Text>
